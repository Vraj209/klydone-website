  ...
  return (
    <Section id="case-studies" background="dark">
      <SectionHeader 
        ...
        badge="What we have done for our clients"
      />
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {caseStudies.map((study, index) => (
          <div 
            key={index} 
            className="bg-gray-800 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300"
          >
            <div className="mb-4">
              <span className="px-4 py-2 bg-violet-600 text-white rounded-full text-sm font-semibold">
                {study.client}
              </span>
            </div>
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-sm font-semibold text-white uppercase mb-2">Challenge</h4>
                <p className="text-white">{study.challenge}</p>
              </div>
              
              <div>
                <h4 className="text-sm font-semibold text-white uppercase mb-2">Solution</h4>
                <p className="text-white">{study.solution}</p>
              </div>
              
              <div>
                <h4 className="text-sm font-semibold text-white uppercase mb-2">Results</h4>
